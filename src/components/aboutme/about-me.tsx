...
export default function AboutMe() {
    return (
        <div className="items-center px-2 sm:px-4 md:px-8 py-4">
            <Container className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-0 items-center">
                <BackgroundBeamsWithCollision>
                    <div className="font-bold text-white text-start px-2 sm:px-4 md:px-0">
                        <p className="text-lg sm:text-xl md:text-3xl lg:text-4xl">Hi! I&apos;m </p>
                        <p className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl">KRISHNNA DEVKOTA</p>
                        <TextReveal text="Frontend Developer" revealText="UI/UX Designer" className="text-xl sm:text-2xl md:text-4xl lg:text-5xl" />
